...
//     //   message:
//     //       '✅ SessionManager: registerSignedInUser: userId=${_signedInUser?.id} with key=$key',
//     // );
...
//       // await NitAlerts.sendAlert(
//       //   message:
//       //       'ℹ️ SessionManager: refreshSession: userId=${_signedInUser?.id}',
//       // );
//       await _storeSharedPrefs();
//       notifyListeners();
//       return true;
//     } catch (e) {
//       await NitAlerts.sendAlert(
//         message: '⚠️ SessionManager: refreshSession error: $e',
//       );
//       return false;
//     }
//   }
